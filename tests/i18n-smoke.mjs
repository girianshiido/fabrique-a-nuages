...
const cases = [
  ...
  ["42.0 k / 100 k aérostats vénusiens déployés sur l’ensemble des Élévations.", "42.0 k / 100 k Venusian aerostats deployed across all Elevations."],
  ...
  ["Effectue 44 captations manuelles avant la fin · Objectif assoupli après échec", "Perform 44 manual captures before time runs out · Eased after a failed attempt"],
  ["44 / 44 · +1.00 B lumens · récompense ×70 %", "44 / 44 · +1.00 B lumens · reward ×70%"],
  ...
  ["91.0 k / 100 k aérostats · 9.00 k restants", "91.0 k / 100 k aerostats · 9.00 k remaining"],
  ["Coût : 1.00 Qi lumens · 10 min. Progression hors ligne à 50 %.", "Cost: 1.00 Qi lumens · 10 min. 50% progress while offline."],
  ["Armada en construction · 4.50 k aérostats civils assemblés. Démarre sous 10 % de corrosion et coupe après 60 % : −15 s.", "Armada under construction · 4.50 k civil aerostats assembled. Start below 10% corrosion and stop after 60%: −15 s."],
  ["Surcadence maîtrisée — Armada accélérée de 15 s !", "Controlled overdrive — Armada accelerated by 15 s!"],
  ...
  ["Lancer l’Armada · 1.00 Qi ◆", "Launch the Armada · 1.00 Qi ◆"],
